...
os.environ["LD_LIBRARY_PATH"] = cuda_lib_path + os.pathsep + cuda_lib_path2 + os.pathsep + os.environ.get("LD_LIBRARY_PATH", "")
...
if not SKIP_CUDA_BUILD and not IS_ROCM:
    ...
    ext_modules.append(        
        CUDAExtension(
            name="element_wise",
            sources=["kernel/element_wise_kernel.cu"],
            extra_compile_args={
